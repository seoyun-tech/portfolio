...
const EXPERIENCES = {
  ko: [
    { type: 'career', name: '포레', sub: '개인 브랜드 대표', period: '2022.05 – 2025.10', duration: '3년 6개월', summary: '상품 기획 · 소싱 · 재고 · 마케팅 전 과정 직접 운영', description: ['시즌당 약 32 SKU 소품종 운영, 재고 효율 극대화', '브랜드 피벗 후 매출 30%↑, D2C 운영 안정화', '카테고리 및 타겟 피벗으로 재고 리스크 해소, 수익성 개선'] },
    { type: 'career', name: '㈜남영비비안', sub: '상품기획 MD', period: '2020.03 – 2022.05', duration: '2년 4개월', summary: '시즌 상품 기획 · 수입 바잉 프로세스 내재화 · 생산 일정 관리', description: ['시즌당 약 350 SKU 기획 및 운영, 카테고리별 발주 및 납기 관리', '3개국(프랑스, 미국, 벨기에) 신규 브랜드 바잉 재편 → 매출 8.2%↑, 목표 108% 달성', '온라인 채널 리뉴얼 기획 → 하반기 매출 31%↑, 촬영 2배, 비용 절감'] },
