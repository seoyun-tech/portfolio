...
const EXPERIENCES = {
  ko: [
    ...
    { type: 'career', name: '㈜남영비비안', sub: '상품기획 MD', period: '2020.03 – 2022.05', duration: '2년 4개월', summary: '시즌 상품 기획 · 수입 바잉 프로세스 내재화 · 생산 일정(TNA) 관리', description: ['시즌당 약 350 SKU 기획 및 운영, 카테고리별 발주 및 납기 관리', '3개국(프랑스, 미국, 벨기에) 신규 브랜드 바잉 구축 → 매출 8.2%↑, 목표 108% 달성', '온라인 채널 리뉴얼 → 하반기 매출 31%↑, 촬영 2배, 비용 절감'] },
    { type: 'education', name: 'MBC 아카데미 (종로)', sub: '웹 개발 과정', period: '2025.10 – 2026.04', duration: '수료', summary: 'AI 기반 콘텐츠 기획 · 반응형 웹 개발(HTML, CSS, JS, React) · 영상 제작' },
  ...
  en: [
    ...
    { type: 'career', name: 'Namyoung Vivien Co., Ltd.', sub: 'Product Planning MD', period: '2020.03 – 2022.05', duration: '2 yrs 4 mos', summary: 'Seasonal product planning · import buying · production lead time (TNA)', description: ['Approx. 350 SKUs per season — planning and operations; ordering and lead time management', 'Planned and built buying across 3 countries (FR·US·BE) → sales +8.2% YoY, 108% of target', 'Led online channel renewal → H2 sales +31% YoY, doubled shoot capacity, reduced operating costs'] },
    { type: 'education', name: 'MBC Academy (Jongno)', sub: 'Web Development', period: 'Oct 2025 – Apr 2026', duration: 'Completed', summary: 'AI-based content planning · Responsive web development (HTML, CSS, JS, React) · Video production' },
